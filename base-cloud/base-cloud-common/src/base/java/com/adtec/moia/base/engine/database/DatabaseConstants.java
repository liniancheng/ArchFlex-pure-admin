...
public class DatabaseConstants {
	public final static int DB_TYPE_DB2 = 1;//db2
	public final static int DB_TYPE_ORACLE = 2;//oracle
	public final static int DB_TYPE_MYSQL = 3;//mysql
	public final static int DB_TYPE_SQLSERVER = 4;//sql server
	public final static int DB_TYPE_OTHER = 0;//other
	public final static int DB_TYPE_INFORMIX = 5;//INFORMIX
	public final static int DB_TYPE_SYBASE = 6;//SYBASE
	public final static int DB_TYPE_HSQL = 7;//hsqldb
	
	public final static String DIALECT_TYPE_DB2 = "DB2";//db2
	public final static String DIALECT_TYPE_ORACLE = "Oracle";//oracle
	public final static String DIALECT_TYPE_MYSQL = "MySQL";//mysql
	public final static String DIALECT_TYPE_SQLSERVER = "SQLServer";//sql server
	public final static String DIALECT_TYPE_INFORMIX = "Informix";//INFORMIX
	public final static String DIALECT_TYPE_SYBASE = "Sybase";//SYBASE
	public final static String DIALECT_TYPE_HSQL = "HSQL";//hsqldb
	...
	public final static String IS_AUTOINCREMENT = "IS_AUTOINCREMENT";//指示此列是否自动增加
