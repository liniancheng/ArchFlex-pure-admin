package com.littlelee.base.common.easyexcel;
...
public class EasyExcelBeanConvert {
	...
	private static Object copyProperties(Object source, Object target) throws BeansException {
		Wrapper wrapper = new EasyExcelBeanConvert().new Wrapper(source);
	...
	public static <T> List<T> convert(List<?> sources, Class<T> targetClass) {
        ...
        EasyExcelBeanConvert.convert(sourcesObj, targets, targetClass);
		return targets;
	}
