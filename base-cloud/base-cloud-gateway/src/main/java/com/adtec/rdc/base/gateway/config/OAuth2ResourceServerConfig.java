...
import com.adtec.rdc.base.gateway.auth.endpoint.AuthExceptionEntryPoint;
import com.adtec.rdc.base.gateway.auth.handler.CustomAccessDeniedHandler;
...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        // 前后分离 先发出options 放行
        config.antMatchers(HttpMethod.OPTIONS, "/**").permitAll().anyRequest().authenticated();
    }
