package com.littlelee.base.auth.captcha;

import com.littlelee.base.common.util.CaptchaUtil;
import com.littlelee.base.common.util.NetworkUtil;
...
public class CaptchaFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        // 添加日志打印
        System.out.println("CaptchaFilter request URI: " + request.getRequestURI());
