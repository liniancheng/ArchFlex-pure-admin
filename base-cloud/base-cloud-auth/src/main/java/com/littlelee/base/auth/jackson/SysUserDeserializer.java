package com.littlelee.base.auth.jackson;
 ...
 * @since 4.2
 */
class SysUserDeserializer extends JsonDeserializer<UserDetailsImpl> {
...
//        Long userId = readJsonNode(jsonNode, "userId").asLong();
        ...
        UserDetailsImpl result = new UserDetailsImpl(userId, username, password, dataScope, deptId, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked,
                authorities);
