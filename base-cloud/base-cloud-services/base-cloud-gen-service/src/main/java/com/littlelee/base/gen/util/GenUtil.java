package com.littlelee.base.gen.util;

import com.littlelee.base.gen.model.config.BaseConfig;
import com.littlelee.base.gen.model.config.ColumnInfoConfig;
import com.littlelee.base.gen.model.config.TableInfoConfig;
...
public class GenUtil {
	...
	public static void buildTableConfig(BaseConfig buildConfig, Configuration configuration,
		...
		if (StringUtils.isEmpty(tableInfoConfig.getPackageName())) {
			tableInfoConfig.setPackageName(configuration.getString("packageName", "com.littlelee"));
		}
		// 模块名
