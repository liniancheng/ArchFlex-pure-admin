...
public class SysAnnoInfo implements Serializable {
	 ...
	 * 公告id
	 */
	@TableId(value = "anno_id", type = IdType.ASSIGN_UUID)
	 ...
	 * 公告等级
	 */
	@TableField(value = "anno_level", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
	private String annoLevel;
	/**
	 * 是否有效
	 */
	@TableField(value = "is_valid", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
	private Integer isValid;
	/**
	 * 公告标题
	 */
	@TableField(value = "anno_title", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
	private String annoTitle;
	/**
	 * 公告内容
	 */
	@TableField(value = "anno_content", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
	 ...
	 * 公告有效期：生效时间
	 */
	@TableField(value = "start_time", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
	private Date startTime;
	/**
	 * 公告有效期：结束时间
	 */
	@TableField(value = "end_time", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
