...
public class SysUserGroupInfo implements Serializable {
     ...
     * 用户组名称
     */
    @TableField(value = "group_name", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String groupName;
    /**
     * 用户组描述
     */
    @TableField(value = "group_rmk", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
