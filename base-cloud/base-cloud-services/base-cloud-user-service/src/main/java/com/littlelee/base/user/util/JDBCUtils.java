package com.littlelee.base.user.util;
...
public class JDBCUtils {
    ...
    public static Connection getConnection(JdbcSource jdbcSource) {
        try {
            Class.forName(jdbcSource.getDriverClass());
            Connection connection = DriverManager.getConnection(jdbcSource.getUrl(), jdbcSource.getUsername(), jdbcSource.getPassword());
            return connection;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
