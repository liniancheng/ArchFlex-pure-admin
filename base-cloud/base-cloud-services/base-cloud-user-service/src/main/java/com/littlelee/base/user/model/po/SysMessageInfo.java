...
public class SysMessageInfo implements Serializable {
     ...
     * 消息类型:1-提醒;2-通知
     */
    @TableField(value = "message_type", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String messageType;

    /**
     * 消息状态:0-未读;1-已读
     */
    @TableField(value = "message_status", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String messageStatus;

    /**
     * 消息标题
     */
    @TableField(value = "message_title", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String messageTitle;

    /**
     * 消息内容
     */
    @TableField(value = "message_content", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String messageContent;

    /**
     * 消息接收用户
     */
    @TableField(value = "message_rev_user", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
