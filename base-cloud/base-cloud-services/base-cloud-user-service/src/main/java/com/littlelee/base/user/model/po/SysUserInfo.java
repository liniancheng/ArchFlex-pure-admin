...
public class SysUserInfo implements Serializable {
     ...
     * 用户名
     */
    @TableField(value = "user_name", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
     ...
     * 邮箱
     */
    @TableField(value = "user_email", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String userEmail;

    /**
     * 手机号码
     */
    @TableField(value = "user_mob_tel", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
     ...
     *登录时间
     */
    @TableField(value = "login_time", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
     ...
     * 主机构号，配合用户组实现主从机构
     */
    @TableField(value = "branch_no", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String branchNo;
    /**
     * 内部加密字段，用于用户同步等操作
     */
    @TableField(value = "crypt_pwd", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
