...
public class SysWorkflowInstanceNode implements Serializable {
     ...
     * 节点ID
     */
    @TableId(value = "INODE_ID", type = IdType.ASSIGN_UUID)
     ...
     */
    @TableField(value = "NODE_STATUS", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String nodeStatus;
    
    /**
     * 当前节点
     */
    @TableField(value = "ACTIVE_FLAG", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
