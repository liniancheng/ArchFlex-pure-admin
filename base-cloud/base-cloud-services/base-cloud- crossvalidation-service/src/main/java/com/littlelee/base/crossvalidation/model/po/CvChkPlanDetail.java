...
public class CvChkPlanDetail implements Serializable {
     ...
     * 计划id
     */
    @TableField(value = "PLAN_ID", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
     ...
     * 执行sql
     */
    @TableField(value = "EXEC_SQL", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String execSql;
                        /**
     * 结果状态 00:未校验  01:已校验
     */
    @TableField(value = "RESULT_STATUS", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
