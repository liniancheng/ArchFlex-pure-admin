...
public class CvChkInd implements Serializable {
     ...
     * 指标名
     */
    @TableField(value = "IND_NM", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String indNm;
    /**
     * 指标等级
     */
    @TableField(value = "IND_LEVEL", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String indLevel;
    /**
     * 父级指标编号
     */
    @TableField(value = "PARENT_NO", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String parentNo;
    /**
     * 触警级别
     */
    @TableField(value = "ALARM_LEVEL", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String alarmLevel;
    /**
     * 指标体系
     */
    @TableField(value = "IND_SYS", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String indSys;
    /**
     * 参考指标
     */
    @TableField(value = "BUS_DIREC", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String busDirec;
    /**
     * 指标释义
     */
    @TableField(value = "IND_EXPR", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String indExpr;
    /**
     * 归口部门
     */
    @TableField(value = "DEPT_NO", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
     ...
     * 更新用户
     */
    @TableField(value = "UPDATE_USER", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String updateUser;
    /**
     * 菜单排序
     */
    @TableField(value = "MENU_ORDER", insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
