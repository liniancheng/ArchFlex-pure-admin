          ...
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="模板内容">
                <a-input v-model="queryParam.tempContent" placeholder="模板内容"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
...
import { fetch, fetchOne, removeById } from '@/api/admin/notice/mailtmp/index'
...
export default {
  ...
  data () {
    return {
      authBtns: {
        insert: this.checkButtonAuth('/admin/notice/mailTemp:insert'),
        update: this.checkButtonAuth('/admin/notice/mailTemp:update'),
        delete: this.checkButtonAuth('/admin/notice/mailTemp:delete'),
        select: this.checkButtonAuth('/admin/notice/mailTemp:select')
      },
      // 高级搜索 展开/关闭  默认关闭
      advanced: false,
      // 查询参数
