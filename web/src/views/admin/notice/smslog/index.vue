          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="服务器ID">
                <a-input v-model="queryParam.srvId" placeholder="服务器ID"/>
              </a-form-item>
            </a-col>
            <template v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item label="发送用户">
                  <a-input v-model="queryParam.smsSendUser" placeholder="发送用户"/>
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
                <a-form-item label="发送状态">
                  <a-select placeholder="请选择" v-model="queryParam.sendStatus">
...
import { fetch, removeById, removeSelected } from '@/api/admin/notice/smslog/index'
...
export default {
  ...
  data () {
    return {
      authBtns: {
        select: this.checkButtonAuth('/admin/notice/smslog:select'),
        delete: this.checkButtonAuth('/admin/notice/smslog:delete')
      },
      // 高级搜索 展开/关闭  默认关闭
      advanced: false,
      // 查询参数
      ...
      columns: [
        ...
        },
        {
            key: 'smsSendUser',
            title: '发送用户',
            dataIndex: 'smsSendUser'
        },
        {
            key: 'smsReceiveUser',
            title: '所有接收者',
            dataIndex: 'smsReceiveUser'
        },
        {
            key: 'sendContent',
            title: '发送内容',
