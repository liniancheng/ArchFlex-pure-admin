    ...
    <a-card :bordered="false">
          ...
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="类型名称">
                <a-input v-model="queryParam.typeName" placeholder="请输入类型名称"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
      ...
      >
        <span slot="action" slot-scope="text, record">
          <template>
            <a class="table_blue" @click="handleEdit(record.typeId)">【修改】</a>
            <a-popconfirm title="确定要删除?" @confirm="() => handleDelete(record.typeId)">
...
import { fetch, fetchOne, removeById } from '@/api/config/annoType/index'
