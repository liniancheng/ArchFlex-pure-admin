                            ...
                            <el-form-item>
                                ...
                                >
                                    ...
                                    <el-button
                                        ...
                                        type="primary"
                                        @click="
                                            useUserStoreHook().SET_CURRENTPAGE(
                                                4
                                            )
                                        "
                                    >
...
import { updateLoginTime, UserResult } from "@/api/user";
...
const loginSuccess = async (res: UserResult) => {
    // 更新登录时间
